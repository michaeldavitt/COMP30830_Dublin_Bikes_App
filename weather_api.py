...
def weather_to_db(weather):
    ...
    vals = (weatherData.get("dt"), int(weatherData.get("sunrise")), int(weatherData.get("sunset")), int(weatherData.get("temp")), int(weatherData.get("feels_like")), int(weatherData.get("pressure")), int(weatherData.get(
